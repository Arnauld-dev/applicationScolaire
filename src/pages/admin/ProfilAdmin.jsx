...
import { FaEnvelope, FaIdCard, FaUserShield, FaPhone, FaCog } from 'react-icons/fa'
      ...
      <div className="row">
        <div className="col-md-4 mb-4">
          <Card className="text-center p-4">
            ...
            <p className="text-muted mb-3">Administrateur</p>
        ...
        <div className="col-md-8">
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                <div className="d-flex align-items-center mb-2">
                  ...
                  <strong>ID Administrateur:</strong>
                </div>
              ...
              <div className="col-md-6 mb-3">
                ...
                <p className="ms-4 mb-0">Administrateur Système</p>
              </div>
          ...
          <Card title="Informations système" className="mt-4">
            <div className="row">
              <div className="col-md-6 mb-3">
                <div className="d-flex align-items-center mb-2">
              ...
              <div className="col-md-6 mb-3">
                ...
                <p className="text-muted mb-0">Accès complet</p>
              </div>
            </div>
          </Card>
        </div>
